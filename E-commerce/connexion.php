                ...
                <div class="card border-0">
                    ...
                    <div class="card-body">
                        <form action="connexion.php" method="post">
                            ...
                            <div class="mb-3">
                              <label for="loginPassword" class="form-label" style="margin-right: 129px;" >Mot de passe</label>
                          ...
                          <div class="mt-2">
                            <a href="registre.php" style="text-decoration: none; color: inherit;">Créer un compte</a>
                          </div>
                    </div>
                </div>
            </div>
