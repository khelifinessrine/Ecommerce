        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <div>
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                    <!-- form-group d-flex">:taaml button recherche w select b7dha b3dhhum -->
                    <div class="form-group d-flex">
                        ...
                        <input type="submit" class="btn btn-primary ml-2" name="btnsearch" value="Recherche"/>
                        </div>
                    ...
                    <div class="modal-body">
                            ...
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                ...
                                <div class="form-group">
                                     ...
                                     <button type="submit" class="btn btn-primary" name="btnsubmit">Sauvegarder</button>
